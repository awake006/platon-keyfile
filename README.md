...
### `platon_keyfile.load_keyfile(path_or_file_obj) --> keyfile_json`
...
```python
>>> from platon_keyfile import load_keyfile
...
### `platon_keyfile.create_keyfile_json(private_key, password, kdf="pbkdf2", work_factor=None, salt_size=16) --> keyfile_json`
...
### `platon_keyfile.decode_keyfile_json(keyfile_json, password) --> private_key`
...
### `platon_keyfile.extract_key_from_keyfile(path_or_file_obj, password) --> private_key`
